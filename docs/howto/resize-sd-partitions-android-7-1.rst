...
2. Resize the parent partition to as desired, note that you need to add the same amount of space to this partition that you want to make available to android
